...
namespace NewUnitStats
{
    ...
    {
        [SerializeField] protected float m_value = 0.0f;

        public delegate void StatAction(float value);
        [System.NonSerialized] StatAction m_onValueChange = null;
    ...
    {
        [SerializeField] float m_maxValue = 0.0f;

        [System.NonSerialized] StatAction m_onMaxValueChange = null;
