...
namespace NewUnitStats.Inventory
{
    ...
    public class InventorySlot<TOwnerClass, TItemClass> where TItemClass : IInventoryItem<TOwnerClass>
    {
        ...
        [SerializeField] TItemClass m_itemType = default;
        ...
        public InventorySlot(InventoryBase<TOwnerClass> owner, int inventoryPosition, InventorySlot<TOwnerClass, TItemClass> copyTarget)
        {
            m_inventoryOwner = owner;
            m_inventoryPosition = inventoryPosition;

            m_itemType = copyTarget.m_itemType;
            m_count = copyTarget.count;

            m_onItemTypeChange = copyTarget.m_onItemTypeChange;
            m_onCountChange = copyTarget.m_onCountChange;
            m_onUse = copyTarget.m_onUse;
    }
