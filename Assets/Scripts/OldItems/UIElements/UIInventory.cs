...
{
    Inventory<Unit, BaseItem> m_inventory = null;
    ...
    public void SetInventory(Inventory<Unit, BaseItem> inventory)
    {
    ...
    UIInventorySlot InstantiateUIInventorySlot(InventorySlot<Unit, BaseItem> inventorySlot)
    {
    ...
    public static string UpdateLabel(InventorySlot<Unit, BaseItem> inventorySlot)
    {
        string labelText;
